...
update : Msg -> (Country.Id -> Cmd msg) -> Model -> ( Model, Cmd msg )
        ...
        GameLoaded gameLoadedModel ->
            case msg of
                CountryMouseUp clickedCountryId ->
                    handleCountryMouseUpFromPlayer gameLoadedModel.session.apiUrl clickedCountryId gameLoadedModel toCountryClickedCommand
...
handleCountryMouseUpFromPlayer : String -> Country.Id -> GameLoadedModel -> (Country.Id -> Cmd msg) -> ( Model, Cmd msg )
handleCountryMouseUpFromPlayer apiUrl clickedCountryId gameLoadedModel toCmd =
    case gameLoadedModel.countryBorderHelperOutlineStatus of
        ...
        CountryBorderHelperOutlineWaitingForDelay countryToShowInfoForId ->
            if clickedCountryId == countryToShowInfoForId then
                ( GameLoaded gameLoadedModel, toCmd clickedCountryId )
