...
export type ResolversTypes = {
  ...
  InternetGameOrConfiguration:
    | ResolversTypes["InternetGameConfiguration"]
    | ResolversTypes["InternetGame"];
  InternetGameConfiguration: ResolverTypeWrapper<InternetGameConfiguration>;
  InternetGamePlayerConfiguration: ResolverTypeWrapper<
...
export type ResolversParentTypes = {
  ...
  PlayerTurnStage: PlayerTurnStage;
  InternetGameOrConfiguration:
    | ResolversParentTypes["InternetGameConfiguration"]
    | ResolversParentTypes["InternetGame"];
...
export type BodyOfWaterResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["BodyOfWater"] = ResolversParentTypes["BodyOfWater"]
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  neighboringCountries?: Resolver<
...
> = {
  ...
  neighboringCountries?: Resolver<
    ...
    ContextType
  >;
  neighboringBodiesOfWater?: Resolver<
    Array<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
export type CountryTroopCountsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["CountryTroopCounts"] = ResolversParentTypes["CountryTroopCounts"]
> = {
...
> = {
  ...
  neutralCountryTroops?: Resolver<
    Array<ResolversTypes["CountryTroopCounts"]>,
    ParentType,
    ContextType
  >;
...
export type InternetGameResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["InternetGame"] = ResolversParentTypes["InternetGame"]
> = {
  game?: Resolver<ResolversTypes["Game"], ParentType, ContextType>;
  currentUserPlayerId?: Resolver<
...
export type InternetGameConfigurationResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["InternetGameConfiguration"] = ResolversParentTypes["InternetGameConfiguration"]
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  players?: Resolver<
    Array<ResolversTypes["InternetGamePlayerConfiguration"]>,
    ParentType,
    ContextType
  >;
...
export type InternetGameOrConfigurationResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["InternetGameOrConfiguration"] = ResolversParentTypes["InternetGameOrConfiguration"]
> = {
  __resolveType: TypeResolveFn<
    "InternetGameConfiguration" | "InternetGame",
    ParentType,
    ContextType
  >;
};

export type InternetGamePlayerConfigurationResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["InternetGamePlayerConfiguration"] = ResolversParentTypes["InternetGamePlayerConfiguration"]
> = {
...
> = {
  ...
  countries?: Resolver<
    ...
    ContextType
  >;
  bodiesOfWater?: Resolver<
    Array<ResolversTypes["BodyOfWater"]>,
    ParentType,
    ContextType
  >;
...
> = {
  createGame?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateGameArgs, "newGame">
  >;
  createInternetGame?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType
  >;
  createMap?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateMapArgs, "map">
  >;
  joinInternetGame?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType,
    RequireFields<MutationJoinInternetGameArgs, "joinGameToken">
  >;
  removePlayer?: Resolver<
    ResolversTypes["Game"],
    ParentType,
    ContextType,
    RequireFields<MutationRemovePlayerArgs, "playerToken" | "playerId">
  >;
  saveGame?: Resolver<
    ResolversTypes["Game"],
    ParentType,
    ContextType,
    RequireFields<MutationSaveGameArgs, "game">
  >;
  saveInternetGame?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationSaveInternetGameArgs, "playerToken" | "game">
  >;
  startInternetGame?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationStartInternetGameArgs, "playerToken">
  >;
  updateMapForInternetGame?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateMapForInternetGameArgs, "playerToken" | "mapId">
  >;
  updatePlayerNameForInternetGame?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
      MutationUpdatePlayerNameForInternetGameArgs,
      "name" | "playerToken"
    >
  >;
  updatePlayerColorForInternetGame?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
      MutationUpdatePlayerColorForInternetGameArgs,
      "color" | "playerToken"
    >
  >;
};
...
export type PlayerTurnResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PlayerTurn"] = ResolversParentTypes["PlayerTurn"]
> = {
  playerId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  playerTurnStage?: Resolver<
    ResolversTypes["PlayerTurnStage"],
    ParentType,
    ContextType
  >;
  fromCountryId?: Resolver<
...
> = {
  ...
  >;
  internetGameOrConfiguration?: Resolver<
    ResolversTypes["InternetGameOrConfiguration"],
    ParentType,
    ContextType,
    RequireFields<QueryInternetGameOrConfigurationArgs, "playerToken">
  >;
  internetGame?: Resolver<
    ResolversTypes["InternetGame"],
    ParentType,
    ContextType,
    RequireFields<QueryInternetGameArgs, "playerToken">
  >;
...
export type Resolvers<ContextType = any> = {
  ...
  InternetGamePlayerConfiguration?: InternetGamePlayerConfigurationResolvers<
    ContextType
  >;
